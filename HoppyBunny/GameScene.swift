...
//  HoppyBunny
//
//  Created by Li Zhang on 6/20/16.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func updateObstacles() {
        ...
        if spawnTimer >= 1.5 {
            ...
            let randomPosition = CGPointMake(352, CGFloat.random(min: 240, max: 383))
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        /* Disable touches if game no longer active */
        if gameState != .Active { return }
        ...
        hero.physicsBody?.applyImpulse(CGVectorMake(0, 210))
